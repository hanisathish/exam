...
?>
  ...
  <div class="col-md-3" style="min-height:84%;padding:5px;color:#212121;background:#CEDDF0;display:none;">
...
<b> <?php echo $this->lang->line('questions');?></b>
	<div style="max-height:60%;overflow-y:auto;">
		...
		for($j=0; $j < $quiz['noq']; $j++ ){
			...
			<div style="display:none;" class="qbtn" onClick="javascript:show_question('<?php echo $j;?>');" id="qbtn<?php echo $j;?>"  ><?php echo ($j+1);?></div>
