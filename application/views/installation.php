	...
	<div class="login-panel panel panel-default">
		...
		?>	<br><hr><br>
			...
			<div class="form-group">	 
 			...
 			<div class="form-group">	  
					<input type="checkbox" name="tos" id="tos"> <span style="font-size:11px;">You must agree to our <a   target="savsoftquiz" >Terms & Conditions</a> before installation</span><br>
