...
if(isset($_FILES['webcam'])){
 ...
 function assign_score($rid,$qno,$score){
	...
	{
		$data['title']="Exam Login";
		// fetching quiz list
		
		$this->load->view('header_quiz_login',$data);
		$this->load->view('quiz_login',$data);
		$this->load->view('footer_quiz_login',$data);
	} 
